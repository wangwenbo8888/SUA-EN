...
set_target_properties(ofstd PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libofstd.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libofstd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ofstd )
list(APPEND _IMPORT_CHECK_FILES_FOR_ofstd "${_IMPORT_PREFIX}/lib/libofstd.dll.a" "${_IMPORT_PREFIX}/bin/libofstd.dll" )
...
set_target_properties(oflog PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/liboflog.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/liboflog.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS oflog )
list(APPEND _IMPORT_CHECK_FILES_FOR_oflog "${_IMPORT_PREFIX}/lib/liboflog.dll.a" "${_IMPORT_PREFIX}/bin/liboflog.dll" )
...
set_target_properties(dcmdata PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmdata.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmdata.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmdata )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmdata "${_IMPORT_PREFIX}/lib/libdcmdata.dll.a" "${_IMPORT_PREFIX}/bin/libdcmdata.dll" )
...
set_target_properties(i2d PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libi2d.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libi2d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS i2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_i2d "${_IMPORT_PREFIX}/lib/libi2d.dll.a" "${_IMPORT_PREFIX}/bin/libi2d.dll" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_stl2dcm "${_IMPORT_PREFIX}/bin/stl2dcm.exe" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_cda2dcm "${_IMPORT_PREFIX}/bin/cda2dcm.exe" )
...
set_target_properties(dcmimgle PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmimgle.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmimgle.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmimgle )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmimgle "${_IMPORT_PREFIX}/lib/libdcmimgle.dll.a" "${_IMPORT_PREFIX}/bin/libdcmimgle.dll" )
...
set_target_properties(dcmimage PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmimage.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmimage.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmimage )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmimage "${_IMPORT_PREFIX}/lib/libdcmimage.dll.a" "${_IMPORT_PREFIX}/bin/libdcmimage.dll" )
...
# Import target "dcmicmp" for configuration "Release"
set_property(TARGET dcmicmp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(dcmicmp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/dcmicmp.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmicmp )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmicmp "${_IMPORT_PREFIX}/bin/dcmicmp.exe" )
...
set_target_properties(dcmjpeg PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmjpeg.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmjpeg.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmjpeg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmjpeg "${_IMPORT_PREFIX}/lib/libdcmjpeg.dll.a" "${_IMPORT_PREFIX}/bin/libdcmjpeg.dll" )
...
set_target_properties(ijg8 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libijg8.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libijg8.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg8 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg8 "${_IMPORT_PREFIX}/lib/libijg8.dll.a" "${_IMPORT_PREFIX}/bin/libijg8.dll" )
...
set_target_properties(ijg12 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libijg12.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libijg12.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg12 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg12 "${_IMPORT_PREFIX}/lib/libijg12.dll.a" "${_IMPORT_PREFIX}/bin/libijg12.dll" )
...
set_target_properties(ijg16 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libijg16.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libijg16.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ijg16 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ijg16 "${_IMPORT_PREFIX}/lib/libijg16.dll.a" "${_IMPORT_PREFIX}/bin/libijg16.dll" )
...
set_target_properties(dcmjpls PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmjpls.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmjpls.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmjpls )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmjpls "${_IMPORT_PREFIX}/lib/libdcmjpls.dll.a" "${_IMPORT_PREFIX}/bin/libdcmjpls.dll" )
...
set_target_properties(charls PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libcharls.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libcharls.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS charls )
list(APPEND _IMPORT_CHECK_FILES_FOR_charls "${_IMPORT_PREFIX}/lib/libcharls.dll.a" "${_IMPORT_PREFIX}/bin/libcharls.dll" )
...
set_target_properties(dcmtls PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmtls.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmtls.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmtls )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmtls "${_IMPORT_PREFIX}/lib/libdcmtls.dll.a" "${_IMPORT_PREFIX}/bin/libdcmtls.dll" )
...
set_target_properties(dcmnet PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmnet.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmnet.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmnet )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmnet "${_IMPORT_PREFIX}/lib/libdcmnet.dll.a" "${_IMPORT_PREFIX}/bin/libdcmnet.dll" )
...
set_target_properties(dcmsr PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmsr.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmsr.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmsr )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmsr "${_IMPORT_PREFIX}/lib/libdcmsr.dll.a" "${_IMPORT_PREFIX}/bin/libdcmsr.dll" )
...
set_target_properties(cmr PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libcmr.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libcmr.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS cmr )
list(APPEND _IMPORT_CHECK_FILES_FOR_cmr "${_IMPORT_PREFIX}/lib/libcmr.dll.a" "${_IMPORT_PREFIX}/bin/libcmr.dll" )
...
set_target_properties(dcmdsig PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmdsig.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmdsig.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmdsig )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmdsig "${_IMPORT_PREFIX}/lib/libdcmdsig.dll.a" "${_IMPORT_PREFIX}/bin/libdcmdsig.dll" )
...
set_target_properties(dcmwlm PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmwlm.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmwlm.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmwlm )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmwlm "${_IMPORT_PREFIX}/lib/libdcmwlm.dll.a" "${_IMPORT_PREFIX}/bin/libdcmwlm.dll" )
...
set_target_properties(dcmqrdb PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmqrdb.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmqrdb.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmqrdb )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmqrdb "${_IMPORT_PREFIX}/lib/libdcmqrdb.dll.a" "${_IMPORT_PREFIX}/bin/libdcmqrdb.dll" )
...
set_target_properties(dcmpstat PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmpstat.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmpstat.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmpstat )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmpstat "${_IMPORT_PREFIX}/lib/libdcmpstat.dll.a" "${_IMPORT_PREFIX}/bin/libdcmpstat.dll" )
...
set_target_properties(dcmrt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmrt.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmrt.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmrt )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmrt "${_IMPORT_PREFIX}/lib/libdcmrt.dll.a" "${_IMPORT_PREFIX}/bin/libdcmrt.dll" )
...
set_target_properties(dcmiod PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmiod.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmiod.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmiod )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmiod "${_IMPORT_PREFIX}/lib/libdcmiod.dll.a" "${_IMPORT_PREFIX}/bin/libdcmiod.dll" )
...
set_target_properties(dcmfg PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmfg.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmfg.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmfg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmfg "${_IMPORT_PREFIX}/lib/libdcmfg.dll.a" "${_IMPORT_PREFIX}/bin/libdcmfg.dll" )

# Import target "dcmfg_tests" for configuration "Release"
set_property(TARGET dcmfg_tests APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(dcmfg_tests PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/dcmfg_tests.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmfg_tests )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmfg_tests "${_IMPORT_PREFIX}/bin/dcmfg_tests.exe" )
...
set_target_properties(dcmseg PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmseg.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmseg.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmseg )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmseg "${_IMPORT_PREFIX}/lib/libdcmseg.dll.a" "${_IMPORT_PREFIX}/bin/libdcmseg.dll" )
...
set_target_properties(dcmtract PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmtract.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmtract.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmtract )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmtract "${_IMPORT_PREFIX}/lib/libdcmtract.dll.a" "${_IMPORT_PREFIX}/bin/libdcmtract.dll" )
...
set_target_properties(dcmpmap PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libdcmpmap.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdcmpmap.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcmpmap )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcmpmap "${_IMPORT_PREFIX}/lib/libdcmpmap.dll.a" "${_IMPORT_PREFIX}/bin/libdcmpmap.dll" )
