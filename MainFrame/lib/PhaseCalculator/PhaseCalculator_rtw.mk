...
MODULES              = PhaseCalculator_rtwutil.c PhaseCalculator_initialize.c PhaseCalculator_terminate.c PhaseCalculator.c set_spot_params.c set_array_params.c sum.c colon.c abs.c divide_element.c cos.c sin.c power.c forward_matrix.c transfer_coords.c repmat.c psuedo_inverse.c inv.c angle.c round.c PhaseCalculator_emxutil.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = PhaseCalculator_rtw.mk
...
MODELLIB                  = PhaseCalculator.dll
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PhaseCalculator_ref.rsp
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = D:\Document\Phase\PHASEC~1
MODELREF_TARGET_TYPE      = rtw:dll
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Document\Phase\PhaseCalculator\codegen\dll\PhaseCalculator
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Document\Phase\PhaseCalculator
