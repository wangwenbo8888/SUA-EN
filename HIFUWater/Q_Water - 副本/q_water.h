...
#define COM_ELE_KEY     0xC2
    #define ELE_COM1        0x01
    #define ELE_COM2        0x02
    #define ELE_COM3        0x03
    #define ELE_COM4        0x04
    #define ELE_COM5        0x05
    #define ELE_COM6        0x06
#define COM_BED_KEY     0xC4
    #define BED_HEADOUT     0x01
    #define BED_WATEROUT    0x02
    #define BED_WATERIN     0x03
#define COM_SCREEN      0xC1
    #define SCREEN_WATERIN  0x01
    #define SCREEN_WATEROUT 0x02
    #define SCREEN_NULL     0x00
#define COM_RODX_CONTROL    0xA2
#define COM_RODY_CONTROL    0xA3
#define COM_RODZ_CONTROL    0xA4
#define COM_RODX_POS        0xB4       //260'
#define COM_RODY_POS        0xB5
#define COM_RODZ_POS        0xB6
#define COM_QUERY_ROD       0xAF
#define COM_BED_ZERO        0xED
#define COM_BED_SET_ZERO    0xEE

#define COM_BED_STATUS        0xEB
    #define COM_BED_LOCK        0x01
    #define COM_BED_UNLOCK      0x00
...
#define COM_SET_PUMP_1      0xE8
#define COM_SET_PUMP_2      0xE9

//#define COM_GET_PAR			0xE8
#define COM_GET_METER		0xE1
#define COM_GET_LEVEL		0xE2
#define COM_GET_Vacuum      0xE3
//#define COM_GET_PUMP_1		0xEA
//#define COM_GET_PUMP_2		0xEB
#define COM_GET_TEMP        0xE5
#define COM_GET_TEMP_2      0xE6
#define COM_GET_TEMP_3      0xE7
