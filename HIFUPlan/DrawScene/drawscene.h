...
// const double RESOLUTION = 2.07692;                           // unit: pixel/mm
// const double ZERO_DEVIATION = 2.2*RESOLUTION;
// // 换算成140mm应该是多少个像素
// const double FOCAL_PLANE_140MM = 140 * RESOLUTION+ZERO_DEVIATION;   // unit: pixel/mm

#endif

//const double X_OFFSET = 274;                                    // unit: pixel
//const double Y_OFFSET = 294;                                    // unit: pixel
// // const double RESOLUTION = 1.3;                               // unit: pixel/mm

// // const double FOCAL_PLANE_140MM = 130 * RESOLUTION;           // unit: pixel

//const double SPOT_WIDTH_DENSITY_HIGH  = 1.0*RESOLUTION;         // 辐照点高密度，辐照点直径1.0mm
//const double SPOT_WIDTH_DENSITY_MIDDLE = 1.4*RESOLUTION;        // 辐照点高密度，辐照点直径1.4mm
//const double SPOT_WIDTH_DENSITY_LOW  = 1.8*RESOLUTION;          // 辐照点高密度，辐照点直径1.8mm

//const double SPOT_WIDTH  = 1.8 * RESOLUTION;                    // unit: pixel
//const double SPOT_LENGTH = 10 * RESOLUTION;                     // unit: pixel
// //const double BEAM_LENGTH = 40 * RESOLUTION;                   // unit: pixel

//const double CENTER_LENGTH = 20*RESOLUTION;
//const double BEAM_LENGTH = 10*RESOLUTION;

//const double SPOT_END_LENGTH = 5*RESOLUTION;
//const double BEAM_END_LENGTH = 40*RESOLUTION;

//const double CELL4MM_LATERAL_DISTANCE = 2 * RESOLUTION;         // unit: pixel
//const double CELL8MM_LATERAL_DISTANCE = 4 * RESOLUTION;         // unit: pixel
//const double CELL12MM_LATERAL_DISTANCE = 6 * RESOLUTION;        // unit: pixel

//const double SPOT_DISTANCE_HIGH = 1.2*RESOLUTION;
//const double SPOT_DISTANCE_MIDDLE = 1.6*RESOLUTION;
//const double SPOT_DISTANCE_LOW = 2.0*RESOLUTION;
