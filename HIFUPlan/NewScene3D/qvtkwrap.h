...
#else
const QString SPOT_FPATH="C:\\HIFUTreation\\USgHIFU\\lib\\PatientSpot.stl";
const QString HUMANMODEL_FPATH="C:\\HIFUTreation\\USgHIFU\\lib\\newHumanmodel.stl";
#endif

//超声图像基本信息
const double USImg_DimX=576.0;
const double USImg_DimY=576.0;
const double USImg_RESOLUTION=2.07692;   // 单位: pixel/mm
const double USImg_X_Lenth=USImg_DimX/USImg_RESOLUTION;
const double USImg_Y_Lenth=USImg_DimY/USImg_RESOLUTION;

//中心点
const double USImg_CenterX=288.0;
const double USImg_CenterY=288.0;
const double USImg_CenterX_Lenth=USImg_CenterX/USImg_RESOLUTION;
const double USImg_CenterY_Lenth=USImg_CenterY/USImg_RESOLUTION;

//自然焦点 -左上角原点 Uper-Left
const double USImg_FocalX=274.0;
const double USImg_FocalY=310.0;
const double USImg_FocalX_Lenth=USImg_FocalX/USImg_RESOLUTION;
const double USImg_FocalY_Lenth=USImg_FocalY/USImg_RESOLUTION;

//自然焦点 -左下角原点 Lower-Left VTK下的方向
const double USImg_FocalX_VTK=274.0;
const double USImg_FocalY_VTK=266.0;
const double USImg_FocalX_Lenth_VTK=USImg_FocalX_VTK/USImg_RESOLUTION;
const double USImg_FocalY_Lenth_VTK=USImg_FocalY_VTK/USImg_RESOLUTION;
...
private slots:
    ...
    void Scene3d_ContextAction_ShowUsImgPlane();
...
private:
    ...
    vtkSmartPointer<vtkSTLReader> _Scene3d_SpotStlReader;
    vtkSmartPointer<vtkTransformPolyDataFilter> _Scene3d_SpotTransformFilter;
    QVector<vtkSmartPointer<vtkPolyData> > _Scene3d_SpotPloyData;

    QString NowIrraPointKey;

    bool bInitIrraPoint; //是否初始化点
    //超声平面
    //vtkSmartPointer<vtkPNGReader> UsImgReader;
    vtkSmartPointer<vtkQImageToImageSource> UsImgQImageToImageSource;
    vtkSmartPointer<vtkTexture> UsImgTexture;
    vtkSmartPointer<vtkPlaneSource> UsImgPlaneSource;
    vtkSmartPointer<vtkPolyDataMapper> UsImgPlaneMapper;
    vtkSmartPointer<vtkActor> UsImgPlaneActor;
    double m_dUSImgAngle;
    //QImage m_curUsImg;
    QImage *m_pSampleUsImg;
    void updateUsImg();
    bool m_bShowUsImg;
    bool m_bAddUsActor;
...
public:
    ...
    void Wrap_LoadTumorStl(const char* path,double *centerOffset);
    ...
    void Wrap_setSpotColor(QString id,QColor color);
    void Wrap_ClearSpot();
